...
const schema = defineSchema({
  ...
  // Applets generated by the Agent and executed in Sandpack
  generatedApplets: defineTable({
    identitySubject: v.string(),
    slug: v.string(),
    name: v.string(),
    ...
    .index("byOwner", ["identitySubject"])
    .index("byOwnerSlug", ["identitySubject", "slug"]),
